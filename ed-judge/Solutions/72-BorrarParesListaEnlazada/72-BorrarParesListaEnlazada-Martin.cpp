...
public:
	...
	{
		//Trivialmente lineal; en un bucle con coste de cada vuelta constante recorremos un elemento
		//La recorremos desde el principio, retirando los elementos pares
		Nodo* act = this->prim;
		//Guardaremos el nodo anterior para dejar la cola en buen estado y cambiar punteros
		Nodo* ant = nullptr;
		//El primero ser� siendo el primero por las especificaciones del problema
		//Booleano para saber cuándo hay que retirar
		bool retirarAhora = false;
		//Recorremos la cola
		while (act != nullptr)
		{
